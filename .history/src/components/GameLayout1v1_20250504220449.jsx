...
export default function GameLayout1v1({ShopHUD, ShopBoard, PlayerBoard, PlayerHUD, Player2HUDFight, Player2BoardFight, Player2Board, Player2HUD, PlayerDeck, Player2Deck, CardPreview, MusicControl, FusionAnim, ProjectileAnim, AnimAoeVisuelle, GriffeEffects, AlertModal}){
  useEffect(() => {
    const updateScale = () => {
