    ...
    const handleDragEnd = (event) => {
        if(actualPlayer === 1){
            ...
            if (sourceType === "shop" && targetType === "footer" && gold >= 3 && deck.length < 7) {
                ...
                if (draggedCard.criCeleste) {
                    let fureurCelesteCount = fureurCeleste + 2
                    setTimeout(() => {
                      lancerAnimationCriDeGuerreAoE(draggedCard.id);
                      setFureurCeleste(fureurCelesteCount) 
                    }, 1000);
                    
                    setTimeout(() => {
                        console.log(fureurCelesteCount) 
                    }, 1500);
                ...
                if(draggedCard.fureurCeleste3Self){
                    ...
                    setTimeout(() => {
                        draggedCard.fureurCeleste3Self(draggedCard, fureurCeleste, setFureurCeleste);
                    }, 1400);
                }
                if(draggedCard.fureurCeleste3OneRandom){
                    if(fureurCeleste > 3){
                        const boardFiltred = board.filter(carte => carte.famille === "Les Sabre-Tempête")
                        if(boardFiltred.length > 0){
                            ...
                            setTimeout(() => {
                                draggedCard.fureurCeleste3OneRandom(cible, fureurCeleste, setFureurCeleste);
                            }, 1400);
                        }
        ...
        if(actualPlayer === 2){
            ...
            if (sourceType === "shop" && targetType === "footer" && goldPlayer2 >= 3 && deckPlayer2.length < 7) {
                ...
                if (draggedCard.criCeleste) {
                    let fureurCelesteCount = fureurCelesteP2 + 2
                    setTimeout(() => {
                      lancerAnimationCriDeGuerreAoE(draggedCard.id);
                      setFureurCelesteP2(fureurCelesteCount) 
                    }, 1000);
                ...
                if(draggedCard.fureurCeleste3Self){
                    ...
                    setTimeout(() => {
                        draggedCard.fureurCeleste3Self(draggedCard, fureurCelesteP2, setFureurCelesteP2);
                    }, 1400);
                }
                if (draggedCard.criDeGuerre) {
                    setTimeout(() => {
