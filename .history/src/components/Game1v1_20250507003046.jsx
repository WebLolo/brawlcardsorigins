            ...
            if (sourceType === "shop" && targetType === "footer" && gold >= 3 && deck.length < 7) {
                ...
                if (draggedCard.criCeleste2) {
                    setTimeout(() => {
                      lancerAnimationCriDeGuerreAoE(draggedCard.id);
                      setFureurCeleste(prev => {
                        const newValue = prev + boardPlayer.length;
                        fureurCelesteRef.current = newValue;
                        console.log("Fureur céleste actualisée :", newValue);
                        return newValue;
                      }); 
                ...
                if(draggedCard.fureurCeleste3Self){
                    if(fureurCelesteRef.current >= 3){
                        ...
                        setTimeout(() => {
                            ...
                            if(draggedCard.nom === "Brise-Nuées Rekkha"){
                                setFureurCeleste(prev => {
                ...
                if(draggedCard.fureurCeleste7All){
                    ...
                    }else if(fureurCelesteRef.current >= 5){
                        const boardFiltred = boardPlayer.filter(carte => carte.famille === "Les Sabre-Tempête")
                        if(boardFiltred.length > 0){
                            setTimeout(() => {
                                lancerAnimationCriDeGuerreAoE(draggedCard.id);
            ...
            if (sourceType === "shop" && targetType === "footer" && goldPlayer2 >= 3 && deckPlayer2.length < 7) {
                ...
                if (draggedCard.criCeleste2) {
                    setTimeout(() => {
                      lancerAnimationCriDeGuerreAoE(draggedCard.id);
                      setFureurCelesteP2(prev => {
                        const newValue = prev + boardPlayer2.length;
                        fureurCelesteRefP2.current = newValue;
                        console.log("Fureur céleste actualisée :", newValue);
                        return newValue;
                      }); 
                ...
                if(draggedCard.fureurCeleste5All){
                    ...
                    }else if(fureurCelesteRefP2.current >= 3){
                        const boardFiltred = boardPlayer2.filter(carte => carte.famille === "Les Sabre-Tempête")
                        if(boardFiltred.length > 0){
                            setTimeout(() => {
                                lancerAnimationCriDeGuerreAoE(draggedCard.id);
                ...
                if(draggedCard.fureurCeleste7All){
                    ...
                    }else if(fureurCelesteRefP2.current >= 5){
                        const boardFiltred = boardPlayer2.filter(carte => carte.famille === "Les Sabre-Tempête")
                        if(boardFiltred.length > 0){
                            setTimeout(() => {
                                lancerAnimationCriDeGuerreAoE(draggedCard.id);
