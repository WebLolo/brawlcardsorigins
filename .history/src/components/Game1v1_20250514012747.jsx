    ...
    const handleDragEnd = (event) => {
        if(actualPlayer === 1){
            ...
            if (sourceType === "deck" && targetType === "board-drop" && boardPlayer.length <7 &&  draggedCard.famille === "Les Hierels") {
                let gioToto = boardPlayer.findIndex(carte => carte.nom === "Gio & Toto")
                if (gioToto >= 0){
                    let newBoard = boardPlayer.filter(carte => carte.nom !== "Gio & Toto").filter(carte => carte.famille === "Les Hierels")
                    let gioTotoDoree = boardPlayer.filter(carte => carte.nom === "Gio & Toto" && carte.estDoree === true)
                    if(elemDeFeteDoree){
        ...
        if(actualPlayer === 2){
            ...
            if (sourceType === "shop" && targetType === "footer" && deckPlayer2.length < 7) {
                ...
                if(draggedCard.fureurCeleste3OneRandom){
                    ...
                    if(fureurCelesteRefP2.current >= 3){
                        ...
                        if(boardFiltred.length > 0){
                            ...
                            setTimeout(() => {
                                draggedCard.fureurCeleste3OneRandom(cible, fureurCelesteRefP2.current, draggedCard);
                                setFureurCelesteP2(prev => {
                                    const newValue = prev - 3;
                                    fureurCelesteRefP2.current = newValue;
                                    console.log("Fureur céleste actualisée :", newValue);
                ...
                if(draggedCard.fureurCeleste5All){
                    if(fureurCelesteRefP2.current >= 5){
                        ...
                        if(boardFiltred.length > 0){
                            ...
                            setTimeout(() => {
                                draggedCard.fureurCeleste5All(boardFiltred, fureurCelesteRefP2.current, draggedCard);
                                setFureurCelesteP2(prev => {
                                    const newValue = prev - 5;
                                    fureurCelesteRefP2.current = newValue;
                                    console.log("Fureur céleste actualisée :", newValue);
                ...
                if(draggedCard.fureurCeleste7All){
                    if(fureurCelesteRefP2.current >= 7){
                        ...
                        if(boardFiltred.length > 0){
                            ...
                            setTimeout(() => {
                                draggedCard.fureurCeleste7All(boardFiltred, fureurCelesteRefP2.current, draggedCard);
                                setFureurCelesteP2(prev => {
                                    const newValue = prev - 7;
                                    fureurCelesteRefP2.current = newValue;
                                    console.log("Fureur céleste actualisée :", newValue);
                ...
                if (draggedCard.criDeGuerre) {
                    ...
                    setTimeout(() => {
                      draggedCard.criDeGuerre(boardPlayer2, draggedCard);
                        ...
                        <>
                            ...
                            <button className="btn btn-danger mt-2 phase" 
                                onClick={async () => {
                                    ...
                                    await verifEffetDebutTour(boardPlayer2, setBoardPlayer2, deckPlayer2, setDeckPlayer2, setFusionAnim, bonusAtkElem, bonusTourbillonDeSable, setBonusAtkElem, setBonusTourbillonDeSable, shopCards, setShopCards, setAnimAoEVisuelle)}}>
                                        Tour Joueur 2
                            </button>
                        </>
                    ) : phase === "apresCombat" ? (
                            ...
                            <button 
                                ...
                                onClick={async () => {
                                    ...
                                    await deroulerCombat1v1({
                                        ...
                                        maxGold, setmaxGold, maxGoldPlayer2, setmaxGoldPlayer2
                                      });
                                }}
                            >
                                Fight !!
