...
export default function GameLayout1v1({ShopHUD, ShopBoard, Player2HUDFight, Player2BoardFight, PlayerBoard, Player2Board, PlayerDeck, Player2Deck, PlayerHUD, Player2HUD}){
  useEffect(() => {
    const updateScale = () => {
