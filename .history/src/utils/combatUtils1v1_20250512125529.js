...
export async function finDeCombat(cartesPlayer, cartesPlayer2, boardAvantCombat, boardAvantCombatPlayer2, lvlTaverne, lvlTavernePlayer2, setBoardPlayer, setBoardPlayer2, goldTour1, setgoldTour1, setGoldPlayer2, setplayerPv, setplayer2Pv, setGold, setShopCards, setActualPlayer, setPhase,deck, setDeck, deckPlayer2, setDeckPlayer2, setFusionAnim, shopCards, bonusTourbillonDeSable, setBonusTourbillonDeSable, bonusAtkElem, setBonusAtkElem, boardPlayer, playerPv, player2Pv, navigate, setPopupMessage, maxGold, setmaxGold, maxGoldPlayer2, setmaxGoldPlayer2){
    ...
    const nouveauGoldJ1 = goldTour1 + 1 + (maxGold - 10);
    if(nouveauGoldJ1 > maxGold){
      nouveauGoldJ1 = maxGold
    }
    const nouveauGoldJ2 = goldTour1 + 1 + (maxGoldPlayer2 - 10);
    if(nouveauGoldJ2 > maxGoldPlayer2){
      nouveauGoldJ2 = maxGoldPlayer2
    }
    setgoldTour1(nouveauGoldJ1)
