...
export async function jouerCarteDepuisDeckIa (card, boardPlayer, setDeck, deck, addBoardPosition, setBoardPlayer, setPopupMessage, shopCards, setBonusTourbillonDeSable, bonusTourbillonDeSable) {
