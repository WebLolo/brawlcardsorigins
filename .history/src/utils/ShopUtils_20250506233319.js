...
export const clonerCarte = ({ carte, camp }) => {
    return {
        ...
        criFureurCeleste5AllFight: carte.criFureurCeleste5SelfFight ? (board, attaquant, fureurValue) => carte.criFureurCeleste5SelfFight(board, attaquant, fureurValue) : null,
