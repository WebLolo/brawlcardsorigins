...
export const lvlUpTaverneIa = ({ gold, lvlTaverne, setGold, setLvlTaverne, setShopCards, actualPlayer, goldPlayer2, lvlTavernePlayer2, setGoldPlayer2,setLvlTavernePlayer2, setPopupMessage }) => {
