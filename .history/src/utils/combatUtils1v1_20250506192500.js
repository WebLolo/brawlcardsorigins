...
export async function TourCombat(
  ...
  fureurCelesteP2, setFureurCelesteP2
){
    console.log(nomAttaquant, "commence")
    console.log(fureurCeleste)
    if(attaquant.criFureurCeleste3SelfFight && nomAttaquant === "joueur" && fureurCeleste >= 3){
      console.log(fureurCeleste)
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);

      attaquant.criFureurCeleste3SelfFight(attaquant, fureurCeleste, setFureurCeleste);
      await sleep(400);
  }
  if(attaquant.criFureurCeleste3SelfFight && nomAttaquant === "joueur2" && fureurCelesteP2 >= 3){
    await sleep(400);
    lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
    await sleep(400);

    attaquant.criFureurCeleste3SelfFight(attaquant, fureurCelesteP2, setFureurCelesteP2);
    await sleep(400);
  }
    ...
    if(defenseur.fureurCeleste3OneRandomDef && nomDefenseur === "joueur"){
      let fureurCelesteValue = fureurCeleste
      console.log(fureurCelesteValue)
      if(fureurCelesteValue >= 3){
          ...
          if(boardFiltred.length > 0){
              const cible = boardFiltred[Math.floor(Math.random() * boardFiltred.length)];
                  ...
                  fureurCelesteValue = fureurCelesteValue - 3
                  await sleep(400);
          }
      }
    }
