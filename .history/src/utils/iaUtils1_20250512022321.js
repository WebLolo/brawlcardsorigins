...
import { lvlUpTaverne, actualiserBoutiqueIA, getCartesPourShop, getCartesAleatoires, getNombreCartesShop, clonerCarte, getCartesSortsPourShop, getNombreCartesSortsShop } from "@/utils/shopUtils";
import { addBoardPosition } from "@/utils/mecaUtils";
import { acheterCarteIa, jouerCarteDepuisDeckIa, lvlUpTaverneIa, coutLvlTavernePlayer2, effetsApresVente, fusionnerCartesIdentiquesIa} from "@/utils/mecaUtilsIa";
...
function applicationEffectIa(boardPlayer2, carteAPoser, setBoardPlayer2, deckPlayer2, setDeckPlayer2, setFusionAnim, shopCards, bonusTourbillonDeSable, bonusAtkElem, setBonusTourbillonDeSable){
  ...
  if (tourIa === 1) {
    ...
    const futurDeck = [...deckPlayer2, cible];
    fusionnerCartesIdentiquesIa({
      carteBase: cible,
      deck: futurDeck,
      board: boardPlayer2,
  ...
  if (tourIa === 4){
    ...
    while (goldPlayer2 > 3){
      ...
      if(planA.length > 0){
        ...
        acheterCarteIa({ cible, goldPlayer2, goldPlayer2, deckPlayer2, setDeckPlayer2, shopCards, setShopCards, lvlTavernePlayer2, actualPlayer, goldPlayer2, deckPlayer2, setGoldPlayer2,setDeckPlayer2, setPopupMessage })
        const futurDeck = [...deckPlayer2, cible];
        const cartedoree = fusionnerCartesIdentiquesIa({
          carteBase: cible,
          deck: futurDeck,
          board: boardPlayer2,
          setDeck: setDeckPlayer2,
        ...
        await sleep(2000); // attente réaliste
        if(cartedoree){
          deckPlayer2 = deckPlayer2.filter((c)=> c.nom !== cible.nom)
          boardPlayer2 = boardPlayer2.filter((c)=> c.nom !== cible.nom)
          deckPlayer2.push(cartedoree)
          await jouerCarteDepuisDeckIa (cartedoree, boardPlayer2, setDeckPlayer2, deckPlayer2, addBoardPosition, setBoardPlayer2, setPopupMessage, shopCards, setBonusTourbillonDeSable, bonusTourbillonDeSable, bonusAtkElem, fureurCelesteRefP2, setFureurCelesteP2)
          await sleep(1500); // attente réaliste
          boardPlayer2.push(cartedoree)
          console.log("test deck : ", deckPlayer2, "test board : ", boardPlayer2, "test carte acheté:", cible, cartedoree)
          deckPlayer2.shift()
          await sleep(1500); // attente réaliste
        }else{
          deckPlayer2.push(cible)
  ...
  if (tourIa === 6){
    ...
    if(goldPlayer2 === 3){
      ...
      if(planA.length > 0){
        ...
        goldPlayer2 = goldPlayer2 -3
        await sleep(2000); // attente réaliste
        if(cible.vaFusionner){
            console.log("test deck : ", deckPlayer2, "test board : ", boardPlayer2, "test carte acheté:", cible)
          }else{
            deckPlayer2.push(cible)
            console.log(deckPlayer2)
            await jouerCarteDepuisDeckIa (cible, boardPlayer2, setDeckPlayer2, deckPlayer2, addBoardPosition, setBoardPlayer2, setPopupMessage, shopCards, setBonusTourbillonDeSable, bonusTourbillonDeSable, bonusAtkElem, fureurCelesteRefP2, setFureurCelesteP2)
    ...
    if(planA.length > 0){
      if(boardPlayer2.length === 7){
          ...
          if(poubelle1.length > 0){
            ...
            goldPlayer2 = goldPlayer2 + 1
            effetsApresVente (poubelle1[0], boardPlayer2, bonusAtkElem, bonusTourbillonDeSable)
            await sleep(800)
            ...
            setGoldPlayer2(goldPlayer2 + 1)
            goldPlayer2 = goldPlayer2 + 1
            effetsApresVente (poubelle2[0], boardPlayer2, bonusAtkElem, bonusTourbillonDeSable)
            await sleep(800)
          }
        }
      if(boardPlayer2.length < 7){
