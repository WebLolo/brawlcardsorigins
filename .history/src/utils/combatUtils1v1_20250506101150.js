...
export async function TourCombat(
  ...
  setFureurCeleste
    ...
    let fureurCountP1 = fureurCeleste
    cartesMortesPlayer.forEach(carteMorte => {
      if (carteMorte.deathFureur){
        
        setFureurCeleste(fureurCountP1++)
        console.log(fureurCountP1)
      }
    ...
    let fureurCountP2 = fureurCeleste    
    cartesMortesPlayer2.forEach(carteMorte => {
      if (carteMorte.deathFureur){
        setFureurCeleste(fureurCountP2++)
        console.log(fureurCountP2)
      }
