...
export function piocherCarteFamille(draggedCard, deck, setDeck, boardPlayer, setBoardPlayer, setFusionAnim){
    if(draggedCard.piocherCarteFamille){
        ...
        if(draggedCard.nom ==="Tek"){
            const cardsSousFamilly = cardsFamilly.filter((c) => c.sousFamille === draggedCard.sousFamille)
            const randomCard = cardsSousFamilly[Math.floor(Math.random() * cardsSousFamilly.length)]
