...
export async function effetsApresVente (card, boardPlayer2) {
  ...
  if(card.nom === "Tornade décuplée"){
    card.piocherCarteFamille = true
    piocherCarteFamille(card, deckPlayer2, setDeckPlayer2, boardPlayer2, setBoardPlayer2, setFusionAnim)
  }
