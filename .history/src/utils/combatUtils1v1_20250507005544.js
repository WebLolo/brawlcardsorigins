...
export async function TourCombat(
  ...
  fureurCelesteP2, setFureurCelesteP2, fureurCelesteRef, fureurCelesteRefP2
    ...
    if(attaquant.criFureurCeleste5SelfFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 5){
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste5SelfFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 3){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
    ...
    if(attaquant.criFureurCeleste5AllFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 5){
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste5AllFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 3){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
    ...
    if(attaquant.criFureurCeleste7AllFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 7){
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste7AllFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 5){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste7AllFight && nomAttaquant === "joueur" && fureurCelesteRef.current >= 3){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
    ...
    if(attaquant.criFureurCeleste5SelfFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 5){
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste5SelfFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 3){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
    ...
    if(attaquant.criFureurCeleste5AllFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 5){
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste5AllFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 3){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
    ...
    if(attaquant.criFureurCeleste7AllFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 7){
      ...
      await sleep(400);
    }else if(attaquant.criFureurCeleste7AllFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 5){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
    ...
    else if(attaquant.criFureurCeleste7AllFight && nomAttaquant === "joueur2" && fureurCelesteRefP2.current >= 3){
      await sleep(400);
      lancerAnimationCriDeGuerreUnique(attaquant.id, attaquant.id);
      await sleep(400);
      ...
      if(fureurCelesteRef.current >= 3){
          ...
          if(boardFiltred.length > 0){
              const cible = boardFiltred[Math.floor(Math.random() * boardFiltred.length)];
                  ...
                  defenseur.fureurCeleste3OneRandomDef(cible, fureurCelesteRef.current);
                  setFureurCeleste(prev => {
                    const newValue = prev - 3;
                    fureurCelesteRef.current = newValue;
                    console.log("Fureur céleste actualisée :", newValue);
    ...
    if(defenseur.fureurCeleste5AllDef && nomDefenseur === "joueur"){
      ...
      if(fureurCelesteRef.current >= 5){
          ...
          if(boardFiltred.length > 0){
                  ...
                  defenseur.fureurCeleste5AllDef(cartesPlayer, fureurCelesteRef.current);
                  setFureurCeleste(prev => {
                    const newValue = prev - 5;
                    fureurCelesteRef.current = newValue;
                    console.log("Fureur céleste actualisée :", newValue);
      ...
      }else if(fureurCelesteRef.current >= 3){
        const boardFiltred = cartesPlayer.filter(carte => carte.famille === "Les Sabre-Tempête")
        if(boardFiltred.length > 0){
      ...
      if(fureurCelesteRefP2.current >= 3){
          ...
          if(boardFiltred.length > 0){
              const cible = boardFiltred[Math.floor(Math.random() * boardFiltred.length)];
                  ...
                  defenseur.fureurCeleste3OneRandomDef(cible, fureurCelesteRefP2.current);
                  setFureurCelesteP2(prev => {
                    const newValue = prev - 3;
                    fureurCelesteRefP2.current = newValue;
                    console.log("Fureur céleste actualisée :", newValue);
    ...
    if(defenseur.fureurCeleste5AllDef && nomDefenseur === "joueur2"){
      ...
      if(fureurCelesteRefP2.current >= 5){
          ...
          if(boardFiltred.length > 0){
                  ...
                  defenseur.fureurCeleste5AllDef(cartesPlayer2, fureurCelesteRefP2.current);
                  setFureurCelesteP2(prev => {
                    const newValue = prev - 5;
                    fureurCelesteRefP2.current = newValue;
                    console.log("Fureur céleste actualisée :", newValue);
