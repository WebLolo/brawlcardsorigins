...
export function piocherCarteApresDecompte( decompteCard, deck, setDeck, boardPlayer, setBoardPlayer, setFusionAnim ){
    if(decompteCard.nom === "Lohan"){
        let piocheDoudou = cards.filter(card => card.sousFamille === "Doudou").filter((c) => c.nom !== draggedCard.nom)
        ...
        let piochePets = cards.filter(card => card.sousFamille === "Les Pets").filter((c) => c.nom !== draggedCard.nom)
