...
export const clonerCarte = ({ carte, camp }) => {
    return {
        ...
        celesteUser: carte.celesteUser !== undefined ? carte.celesteUser : false,
        fureurCeleste3Self: carte.fureurCeleste3Self ? (self, fureurValue, setter) => carte.fureurCeleste3Self(self, fureurValue, setter) : null,
        deathFureur: carte.deathFureur !== undefined ? carte.deathFureur : false,
        criFureurCeleste3SelfFight : carte.criFureurCeleste3SelfFight ? (self, fureurValue, setter) => carte.criFureurCeleste3SelfFight(self, fureurValue, setter) : null,
        fureurCeleste3OneRandom: carte.fureurCeleste3OneRandom ? (cible, fureurValue, setter) => carte.fureurCeleste3OneRandom(cible, fureurValue, setter) : null,
        touchFureur: carte.touchFureur !== undefined ? carte.touchFureur : false,
        fureurCeleste3OneRandomDef: carte.fureurCeleste3OneRandomDef ? (cible, fureurValue, setter) => carte.fureurCeleste3OneRandomDef(cible, fureurValue, setter) : null,
