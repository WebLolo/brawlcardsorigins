  ...
  export async function TourIa({
    ...
    if (tourIa === 1) {
        ...
        if (goldPlayer2 >= 3) {
          ...
          applicationEffectIa(boardPlayer2, cible, setBoardPlayer2, deckPlayer2, setDeckPlayer2, setFusionAnim, shopCards, bonusTourbillonDeSable, bonusAtkElem, setBonusTourbillonDeSable)
    ...
    await sleep(50);
      ...
      while(goldPlayer2 > 3){
        ...
        if(planA.length > 0){
          ...
          applicationEffectIa(boardPlayer2, carteCible, setBoardPlayer2, deckPlayer2, setDeckPlayer2, setFusionAnim, shopCards, bonusTourbillonDeSable, bonusAtkElem, setBonusTourbillonDeSable)
        }else{
          //Actualiser Shop
