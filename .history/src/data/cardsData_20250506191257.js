...
export const cards = [
  ...
  },
  {
    ...
    provocation: true,
    provocationUse: true,
    fureurCeleste3OneRandomDef: (cible, fureurValue, setter) => {
      if (fureurValue >= 3){
        cible.atk += 2;
        cible.buffAtk += 2;
        cible.hp += 2;
  ...
  },
  {
    ...
    texte: "*",
    deathFureur: true,
    criFureurCeleste3SelfFight: (self, fureurValue, setter) => {
      if (fureurValue >= 3){
        self.atk += 2;
        self.buffAtk += 2;
        setter(prev => {
  ...
  },
  {
    ...
    texte: "*",
    deathFureur: true,
    fureurCeleste3OneRandom: (cible, fureurValue, setter) => {
      if (fureurValue >= 3){
        cible.hp += 2;
        cible.buffHp += 2;
        setter(prev => {
  ...
  },
  {
    ...
    fureurCeleste3Self: (self, fureurValue, setter) => {
      if (fureurValue >= 3){
        self.atk += 1;
        self.buffAtk += 1;
        self.hp += 1;
