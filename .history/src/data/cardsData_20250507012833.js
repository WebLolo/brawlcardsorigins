...
export const cards = [
  ...
  },
  {
    ...
    criFureurCeleste7AllFight: (board, attaquant, fureurValue) => {
      if (fureurValue >= 7){
        ...
        attaquant.atk += fureurValue;
        attaquant.buffAtk += fureurValue;
        attaquant.hp += fureurValue;
        attaquant.buffHp += fureurValue;
  ...
  },
  {
    ...
    texte: "*",
    deathFureur: true,
    fureurCeleste3All: (board, fureurValue) => {
      if (fureurValue >= 3){
        board.forEach(card =>{
          if(card.famille === "Les Sabre-Tempête"){
            card.atk += 2;
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "Au moment d'attaquer, si vous possedez au moins 3 fureur Celeste, elle gagne +2hp. Consomme 3 charges",
    deathFureur: true,
    criFureurCeleste3SelfFight: (self, fureurValue) => {
      if (fureurValue >= 3){
        self.hp += 2;
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "Cri: +2hp à un Sabre-Tempête aléatoire. Consomme 3 fureur Celeste",
    deathFureur: true,
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "+1 Fureur Celeste à chaque fois qu'il est attaqué",
    deathFureur: true,
    provocation: true,
    provocationUse: true,
    touchFureur: true,
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "Cri: Si Fureur Celeste sup. ou égal à 3 : gagne +1/+1. En combat: à sa mort, Fureur Celeste +1 ",
    fureurCeleste3Self: (self, fureurValue) => {
      if (fureurValue >= 3){
        self.atk += 1;
        self.buffAtk += 1;
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "Cri: Fureur Celeste +2, en combat : à sa mort, Fureur Celeste +1",
    criCeleste: true,
    deathFureur: true,
  },
]