...
export const cards = [
  ...
  },
  {
    ...
    famille: "Sort",
    texte: "<br><i>Bouclier en Bois</i> <br><br><br> Donne <color=red>+4 Hp</color> au serviteur <br><br> le plus à gauche <br><br> du board",
    lancerSort: (setter, gold, board) => {
      if(board.length > 0){
        board[0].hp += 4;
        board[0].buffHp += 4;
  ...
  },
  {
    ...
    famille: "Sort",
    texte: "<br><i>Gardien</i> <br><br><br> Donne <i>Gardien</i> au <br><br> serviteur le plus à gauche du board",
    lancerSort: (setter, gold, board) => {
      if(board.length > 0){
  ...
  },
  {
    ...
    famille: "Sort",
    texte: "Lien Spirituel : Pioche une carte d'un lvl inferieur et de la même famille que celle la plus à gauche du Board",
    lancerSort: (setter, gold, board, shop, setterDeck, deck, setterShop) => {
  ...
  },
  {
    ...
    famille: "Sort",
    texte: `<br> Interet : Augmente votre maximum d'or de 1`,
