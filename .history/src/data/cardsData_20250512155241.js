...
export const cards = [
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "<i>Cri</i><br><br> Si <i><color=aqua>Fureur Celeste</color></i> sup. ou <br><br> égal à <color=aqua>3</color> : gagne <color=red>+1/+1</color> <br><br> Consomme <color=aqua>3</color> charges",
    fureurCeleste3Self: (self, fureurValue) => {
      if(self.estDoree){
        if (fureurValue >= 3){
          self.atk += 1 * 2;
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "<br><i>Cri</i><br><br><br> Fureur Celeste <color=red>+5</color>",
    criCeleste: true,
    deathFureur: true,
  },
  {
