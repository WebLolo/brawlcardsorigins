...
export const cards = [
  ...
  },
  {
    ...
    famille: "Sort",
    texte: "Vous gagnez 1 pièce d'or.",
  ...
  },
  {
    ...
    lancerSort: (setter, gold, board, shop, setterDeck, deck, setterShop) => {
      const cardsFamilleLvl1 = cards.filter(c => c.lvl < board[0].lvl && c.famille !== "Sort" && c.famille === board[0].famille)
      const randomCardsLvl1 = cardsFamilleLvl1[Math.floor(Math.random() * cardsFamilleLvl1.length)]
      let newDeck = deck.push(randomCardsLvl1)
      setterDeck(newDeck)
    }
  },
