...
export const cards = [
  ...
  },
  {
    ...
    famille: "Les Hierels",
    texte: "<br><i>Cri et tous les 2 tours</i> <br><br><br> Piochez une carte <br><br> <color=white>Chat-Miaou</color>",
    carteSpe: 117,
    piocherCarteSpe: true,
    decomptePioche: 2,
  },
  {
    ...
    famille: "Les Hierels",
    sousFamille: "Doudou",
    texte: "<br><i>Renforcement du maitre</i> <br><br><br> Donne <color=red>+2/+2</color> à Lohan",
    criDeGuerre: (cartesBoard, draggedCard) => {
      if(draggedCard.estDoree){
        cartesBoard.forEach(carte => {
          if(carte.nom === "Lohan"){
  ...
  },
  {
    ...
    famille: "Les Hierels",
    sousFamille: "Doudou",
    texte: "<br><i>Renforcement du maitre</i> <br><br><br> Donne <color=red>+2</color> à Lohan",
    criDeGuerre: (cartesBoard, draggedCard) => {
      if(draggedCard.estDoree){
        cartesBoard.forEach(carte => {
          if(carte.nom === "Lohan"){
