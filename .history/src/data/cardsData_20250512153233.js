...
export const cards = [
  ...
  },
  {
    ...
    famille: "Sort",
    texte: "<br><i>Bouclier en Bois</i> <br><br><br> Donne <color=red>+4 Hp</color> au <br><br> serviteur le plus à gauche du board",
    lancerSort: (setter, gold, board) => {
      if(board.length > 0){
        board[0].hp += 4;
        board[0].buffHp += 4;
  ...
  },
  {
    ...
    famille: "Sort",
    texte: "<br><i>Gardien</i> <br><br><br> Donne <i>Gardien</i> au serviteur <br><br> le plus à gauche du board",
    lancerSort: (setter, gold, board) => {
      if(board.length > 0){
