...
export const cards = [
  ...
  },
  {
    ...
    famille: "Les Sabre-Tempête",
    texte: "<i>Cri</i><br><br> Si <color=blue>Fureur Celeste</color> sup. ou <br><br> égal à <color=aqua>3</color> : gagne <color=red>+1/+1</color> <br><br> Consomme <color=blue>3</color> charges",
    fureurCeleste3Self: (self, fureurValue) => {
      if(self.estDoree){
        if (fureurValue >= 3){
          self.atk += 1 * 2;
