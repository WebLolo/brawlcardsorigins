...
export const cards = [
  ...
  },
  {
    ...
    famille: "Croc-Noir",
    sousFamille : "Terrestre",
    texte: "Aura: +1 hp pour tous les Croc-Noir du Board. Bivalence mer: Zûn'Tul gagne furie. Bivalence Terre: Zûn'Tul gagne Provocation",
    provocation: true,
    provocationUse: false,
    furie: true,
    furieUse: false,
  ...
  },
  {
    ...
    famille: "Les Sylphariels",
    sousFamille : "Light",
    texte: "Cri: +1hp à toutes les fées sur le Board. Evanescence: +1hp à une fée (vente/mort)",
    criDeGuerre: (cartesBoard) => {
      cartesBoard.forEach(carte => {
        if(carte.famille === "Les Sylphariels"){
          carte.hp += 1;
